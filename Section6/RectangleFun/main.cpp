...
int main() {
    ...
    cout << "====Perimeter======" << endl;
    cout << "Perimeter of length " << r1.getLength() << " width " 
        << r1.getWidth() << " is " << r1.perimeter() << endl;
    cout << "Perimeter of length " << r2.getLength() << " width " 
        << r2.getWidth() << " is " << r2.perimeter() << endl;
